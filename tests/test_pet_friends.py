...
def test_add_new_pet_with_valid_data(name='Prima', animal_type='леопард',
                                     age='5', pet_photo='images/photo.jpg'):
...
def test_add_new_pet_with_valid_special_characters_data(name='!"№;%:?*()_+@#$%^&*_+', animal_type='!"№;%:?*()_+@#$%^&*_+',
    ...
    assert status == 200
    assert result['name'] == name
def test_add_new_pet_with_not_valid_data_faild(name='Рima', animal_type='леопард',
                                     age='А', pet_photo='images/photo.jpg'):
...
def test_add_new_pet_with_valid_2_data(name='xxxxxxxxxxxxxxxxxxxx', animal_type='xxxxxxxxxxxxxxxxxxxx',
                                     age='А', pet_photo='images/photo.jpg'):
    """5 с валидными данными в размере 20 символов в разделах animal_type и name """
...
def test_add_new_pet_with_not_valid_data_faild(name='', animal_type='',
                                     age='', pet_photo='images/photo.jpg'):
...
def test_successful_delete_self_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet(auth_key, "Сэм", "кот", "3", "images/photo.jpg")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
...
def test_successful_update_self_pet_info(name='Марс', animal_type='Лео', age='7'):
...
def test_add_new_pet_without_photo_with_valid_data(name='Bob', animal_type='собака',
                                     age='8'):
...
def test_post_change_pet_foto(pet_photo='images/photo2.jpg'):
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pet_without_photo(auth_key, "Сэм", "кот", "3")
        _, my_pets = pf.get_list_of_pets(auth_key, "my_pets")
